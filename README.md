...
The current downloads can be found here:
 ...
 - [Precompiled Modelica library](https://github.com/modelica-3rdparty/ExternalMedia/releases/download/v3.4.0/ExternalMedia_v3.4.0.zip)
 - [Manual as PDF](https://github.com/modelica-3rdparty/ExternalMedia/releases/download/v3.4.0/ExternalMedia_v3.4.0.pdf)
 - [Full source code](https://github.com/modelica-3rdparty/ExternalMedia/archive/refs/tags/v3.4.0.zip)
...
The current release of the library (3.4.0) includes a pre-compiled interface to
...
Please open the `package.mo` file inside the `ExternalMedia 3.4.0` folder to
